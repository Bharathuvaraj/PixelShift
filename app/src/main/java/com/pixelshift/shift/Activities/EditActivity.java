...
import com.pixelshift.shift.BuildConfig;
...
public class EditActivity extends AppCompatActivity{
    ...
    RelativeLayout editorLayout, cameraLayout;
    ...
    private void init() {
        editorLayout = findViewById(R.id.edit_botton);
        cameraLayout = findViewById(R.id.camera_button);
    ...
    private void openCamera() {
        ...
        Dexter.withContext(EditActivity.this).withPermissions(cameraPermisscions)
    ...
    private void editPhoto() {
        ...
        Dexter.withContext(EditActivity.this).withPermissions(editPermissions).withListener(new MultiplePermissionsListener() {
            public void onPermissionsChecked(MultiplePermissionsReport multiplePermissionsReport) {
                if (multiplePermissionsReport.areAllPermissionsGranted()) {
        ...
        }).withErrorListener(dexterError -> Toast.makeText(EditActivity.this, "Error occurred! ", Toast.LENGTH_SHORT).show()).onSameThread().check();
    }
